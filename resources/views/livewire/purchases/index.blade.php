<div>
        ...
        <div class="mb-4 flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-teal-200 bg-teal-50 px-4 py-3">
            ...
            <div class="flex gap-2">
                <button
                    ...
                    wire:confirm="Soft delete {{ count($selected) }} purchase(s)? They can be restored from the Bin later."
    ...
    <div class="overflow-hidden rounded-2xl border border-slate-200/80 bg-white shadow-sm">
        ...
        <div class="border-t border-slate-100 px-4 py-4 text-center">
            ...
            @else
                <p class="text-xs text-slate-400">Showing all {{ $purchases->total() }} purchases.</p>
            @endif
        </div>
    </div>
